...
const config = input.config({
    title: 'Le Menu de la Passerelle',
    description: 'Un script pour les gouverner tous...',
    items: [
        input.config.text('webhookUrl', {
            label: 'URL du webhook déclenchant le script principal',
        })
    ]
});
...
if (cursorTable == menuTable) {
    ...
    syncType = commande.getCellValueAsString('Type');
